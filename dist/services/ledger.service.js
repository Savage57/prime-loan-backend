...
class LedgerService {
    ...
    static createEntry(params, session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [ledgerEntry] = yield ledger_model_1.default.create([entry], { session });
            return ledgerEntry;
        });
    }
    /**
    ...
    static getByTraceId(traceId) {
        return __awaiter(this, void 0, void 0, function* () {
            return ledger_model_1.default.find({ traceId }).sort({ createdAt: 1 });
        });
    }
    /**
    ...
    static updateStatus(entryId, status, session) {
        return __awaiter(this, void 0, void 0, function* () {
            yield ledger_model_1.default.findByIdAndUpdate(entryId, {
                status,
    ...
    static getUserWalletBalance(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const result = yield ledger_model_1.default.aggregate([
                {
                    $match: {
    ...
    static findInconsistencies() {
        return __awaiter(this, void 0, void 0, function* () {
            return ledger_model_1.default.aggregate([
                {
